  ...
  <el-card class="app-container" shadow="always">
    ...
    <el-form ref="rules" :model="userInfo" :rules="rules" label-width="120px">
      ...
      <el-form-item label="Phone number" prop="phone">
        <el-input v-model.number="userInfo.phone" disabled placeholder="Please enter phone number" />
      </el-form-item>
      <el-form-item label="email" prop="email">
        <el-input v-model="userInfo.email" disabled placeholder="Please enter email address" />
      </el-form-item>
      <el-form-item>
    ...
    onSubmit() {
      this.$refs['rules'].validate(valid => {
        if (valid) {
          ...
          this.userInfo.status = this.status == true ? 1 : 0

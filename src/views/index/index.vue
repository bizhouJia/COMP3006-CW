        ...
        <div class="header-right">
          ...
          <el-dropdown trigger="hover" @command="dropdownComm">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="index">Main Page</el-dropdown-item>
          ...
          <div class="admin-logo">
            <img :src="userInfo.avatar ? userInfo.avatar : defaultavatar" alt="Cannot find the photo">
          </div>
        </div>
      </div>
    </el-header>
    ...
    dropdownComm(command) {
      switch (command) {
        ...
        case 'userInfo':
          ...
          break;
        case 'modifyPw':
          this.$router.push({ path: '/index/modify' });
          break;
        case 'chatRoom':

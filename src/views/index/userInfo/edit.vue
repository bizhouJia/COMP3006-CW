  ...
  <el-card class="app-container" shadow="always">
    ...
    <el-form ref="rules" :model="userInfo" :rules="rules" label-width="120px">
      <el-form-item label="Name" prop="name">
        <el-input v-model="userInfo.name" placeholder="Please enter user name" />
      </el-form-item>
      <el-form-item label="Account" prop="account">
        <el-input v-model="userInfo.account" disabled placeholder="Please enter user name" />
      </el-form-item>
      ...
      <el-form-item label="Phone Number" prop="phone">
        <el-input v-model.number="userInfo.phone" placeholder="Please enter user phone number" />
      </el-form-item>
